    ...
    return (
        ...
        <Box mt = {0} sx ={{px:0}} id = "hero-box">
            ...
            <Box id = "social-media" sx = {{position: "absolute", bottom: 250}}>
                <Link href="https://www.facebook.com/aplaya" target="_blank" rel="noopener noreferrer">
            ...
            <Box id = "Owner" sx = {{position: "absolute", bottom: 120, display: "flex", alignItems: "center"}}>
