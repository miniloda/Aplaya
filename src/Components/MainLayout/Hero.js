  ...
  const handleClose = () => setOpen(false);
    ...
    useEffect(() => {
        ...
        if (document.getElementById("heroButton") !== null) {
            ...
            document.getElementById("social-media").style.right = screenWidth /2 - buttonWidth/2 + "px";
            document.getElementById("social-media").style.width = buttonWidth + "px";
        }
    ...
    return (
        ...
        <Box sx ={{px:0}} id = "hero-box">
            ...
            <Box id = "social-media" sx = {{position: "absolute", bottom: 250}}>
            ...
            <Link href = "#about"><Button variant="outlined" id = "heroButton" className = "not-seen" disableElevation sx = {{position: "absolute", bottom: 200}}>Get Started</Button></Link>
            <Box id = "Owner" sx = {{position: "absolute", bottom: 120, display: "flex", alignItems: "center"}} className = "not-seen">
